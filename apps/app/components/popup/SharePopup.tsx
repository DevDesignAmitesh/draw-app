...
const SharePopup = ({
  ...
  return (
    ...
    >
      <div
        className="w-[400px] h-[400px] rounded-md bg-[#232329] flex flex-col justify-center items-center"
        onClick={(e) => e.stopPropagation()}
      >
        <h2 className="text-2xl tracking-wider font-semibold text-[#A8A5FF]">
          Live collaboration
        </h2>
        <p className="text-base mt-8 tracking-widest text-center text-neutral-50">
        ...
        <button
          ...
          className="dark:bg-[#4F4D6F] mt-6 rounded-md bg-[#5B57D1] dark:text-neutral-50 text-neutral-50 py-2 px-4 flex justify-center items-center gap-2 cursor-pointer font-normal"
        >
          <IoIosLink />
          <p>Share Link</p>
        </button>
