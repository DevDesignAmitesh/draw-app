...
const Hero = () => {
  return (
    <>
      ...
      >
        <p className="text-[58px] tracking-widest text-[#030064]">
          Online <span className="p-2 bg-[#D3FFD2] rounded-md">Whiteboard</span>{" "}
          made simple
        </p>
        <p className="text-[#030064] mt-3 text-[20px] tracking-wider">
          Ideate, Collaborate, Share. Simply with Excalidraw.
        </p>
        <p className="text-[#030064] tracking-widest py-1 px-3 mt-7 text-[14px] rounded-md bg-[#ffe599] border-2 border-[#705400] hover:bg-white cursor-pointer transition-all duration-200">
