...
const PlusFeature = () => {
  return (
    <div className="relative w-full min-h-[70vh] flex lg:flex-row flex-col justify-between items-center lg:px-60 md:px-20 px-10 py-10 bg-[#F0FBFF]">
      <div className="flex flex-col justify-center lg:items-start items-center text-[#030064]">
        <Plus />
